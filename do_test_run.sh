...
DOCKER_IMAGE_TAG="example_algorithm_preliminary-development-phase-task-2"
CONTAINER_NAME="example_algorithm_preliminary-development-phase-task-2_container"
