...
DOCKER_IMAGE_TAG="example_algorithm_preliminary-development-phase-task-1-wo-ssl"
CONTAINER_NAME="example_algorithm_preliminary-development-phase-task-1-wo-ssl_container"
